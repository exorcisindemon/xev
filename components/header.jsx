    ...
    >
      <div className="flex flex-row flex-wrap gap-4 items-center">
        ...
        <button
          onClick={likeHandler}
          disabled={userLiked}
          className="transition-all bg-amber-600/20 hover:bg-amber-600/40 ring-1 ring-amber-600 flex flex-row gap-2 items-center w-fit px-4 py-2 mt-0 rounded-full"
        >
