...
const Hero = () => {
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-center gap-4 w-auto">
        ...
        <div className="flex flex-row gap-4 items-center">
          <button className="transition-all bg-slate-600/20 hover:bg-slate-600/40 ring-1 ring-slate-600 flex flex-row gap-2 items-center w-fit p-2 mt-0 rounded-full">
            <Image src={Apple} width="16" height="16" />
          </button>
          <button className="transition-all bg-stone-600/20 hover:bg-stone-600/40 ring-1 ring-stone-600 flex flex-row gap-2 items-center w-fit p-2 mt-0 rounded-full">
            <Image src={GitHub} width="16" height="16" />
          </button>
          <button className="transition-all bg-red-600/20 hover:bg-red-600/40 ring-1 ring-red-600 flex flex-row gap-2 items-center w-fit p-2 mt-0 rounded-full">
