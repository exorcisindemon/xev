...
const Documentation = () => {
  return (
    <main className="flex flex-col lg:grid lg:grid-cols-4 w-full h-auto lg:h-[480px] items-center justify-center gap-8 lg:gap-16 p-8 lg:p-16">
      <div className="flex flex-col w-full">
        <p className="text-black text-4xl font-semibold tracking-tight w-full text-start mt-0">
          Documentation
        </p>
